...
const portfolioProjects = [
  {
    ...
    results: [
      ...
      { title: "Paypent Gateways Including Crypto" },
    ],
...
export const ProjectsSection = () => {
  return <div>
    <div className="container">
      ...
      <p className="uppercase font-semibold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text text-center ">Real-World Results</p></div>
